...
public class TinyDB {
    ...
    public ArrayList<Pets> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Pets> playerList =  new ArrayList<Pets>();

        for(String jObjString : objStrings){
            Pets player  = gson.fromJson(jObjString,  Pets.class);
    ...
    public void putListObject(String key, ArrayList<Pets> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Pets player: playerList){
